...
<html><?php session_start(); ?>
    <?php 
        include 'koneksi.php';
        $kd_sb=$_GET['kd_sb'];
        $query=mysql_query("select * from subbidang where kd_sb='$kd_sb'");
    ?>
<head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">EDIT BIDANG</h4>
            ...
            <div class="col-lg-6 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        ?>
                        <div class="card-body">
                        <form action="edit-bidang.php" method="POST" name="input">
                        <input type="hidden" name="kd_sb" value="<?php echo $kd_sb;?>" />
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama</label>
                                        <input type="text" class="form-control" id="validationCustom05" name="nm_lengkap_sb" value="<?php echo $row['nm_lengkap_sb']; ?>" required="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Singkatan</label>
                                        <input type="text" class="form-control" id="validationCustom05" name="nm_sb" value="<?php echo $row['nm_sb']; ?>" required="">
                                    </div>
                                    <input type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="edit-bidang">
                                </form>
                            <?php } ?>
                            </div>
                        </div>
