...
<html><?php session_start(); ?>
    <?php 
        include 'koneksi.php';
        $kd=$_GET['kd'];
        $query=mysql_query("select * from kelas_surat where kd='$kd'");
    ?>
<head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">EDIT KELAS SURAT</h4>
            ...
            <div class="col-lg-6 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        ?>
                        <div class="card-body">
                        <form action="edit-kelas.php" method="POST" name="input">
                            <input type="hidden" name="kd" value="<?php echo $kd;?>" />
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Kode Kelas</label>
                                        <input type="text" class="form-control" id="validationCustom05" name="kd_kelas" value="<?php echo $row['kd_kelas']; ?>" required="">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Nama Kelas</label>
                                        <input type="text" class="form-control" id="validationCustom05" name="nm_kelas" value="<?php echo $row['nm_kelas']; ?>" required="">
                                    </div>
                                    <input type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="edit-kelas">
                                </form>
                            <?php } ?>
                            </div>
                        </div>
