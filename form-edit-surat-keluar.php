...
<?php session_start(); ?>
    <?php 
        include 'koneksi.php';
        $kd_sk=$_GET['kd_sk'];
        $query=mysql_query("select * from surat_keluar where kd_sk='$kd_sk'");
    ?>
<head>
    <meta charset="utf-8">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Surat Keluar</h4>
    ...
    <div class="main-content-inner">
        <div class="col-12 mt-5">
            <div class="card">
                ...
                ?>
                <div class="card-body">
                    <form class="needs-validation" novalidate="" ENCTYPE="multipart/form-data" method="POST" action="edit-surat-keluar.php" name="edit-surat-keluar">
                    <input type="Hidden" name="kd_sk" value="<?php echo $kd_sk;?>" />
                    <div class="form-row">
                        <div class="col-3">
                            <label for="validationCustom05">Kelas Surat</label>
                            <select name="kd_kelas" value="<?php echo $row['kd_kelas']; ?>" type="text" class="form-control" id="validationCustom01" required="">
                                <?php 
                                    include "koneksi.php";
                        ...
                        <div class="col-3">
                            ...
                            <input name="no_surat" value="<?php echo $row['no_surat']; ?>" type="text" class="form-control" id="validationCustom05" placeholder="No. Surat"  required="">
                        ...
                        <div class="col-3">
                            <label for="validationCustom05">Tanggal Penyampaiana</label>
                            <input value="<?php echo $row['tgl_penyampaian']; ?>" type="date" class="form-control" id="validationCustom05" placeholder="Zip" name="tgl_penyampaian" required="">
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        ...
                        <div class="col-3">
                            ...
                            <select name="pengelola" value="<?php echo $row['pengelola']; ?>" type="text" class="form-control" id="validationCustom01" required="">
                        ...
                        <div class="col-3">
                            ...
                            <input value="<?php echo $row['tujuan']; ?>" type="tex" class="form-control" id="validationCustom05" placeholder="Tujuan" name="tujuan" required="">
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        <div class="col-3">
                            ...
                            <div class="controls">
                                <input name="gambar" value="<?php echo $row['gambar']; ?>" class="form-control" type="file"placeholder="" id="validationCustom05">
                            </div>
                        </div>
                        <div class="col-3">
                            <label for="validationCustom05">Tempat Simpan</label>
                            <input value="<?php echo $row['tempat_simpan']; ?>" type="tex" class="form-control" id="validationCustom05" placeholder="Zip" name="tempat_simpan" required="">
                        </div>
                    </div>
                    <br>
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-primary mt-4 pr-4 pl-4" name="edit-surat-keluar">
                    </form>
                    <?php } ?>
                </div>
            </div>
