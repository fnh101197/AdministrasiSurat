                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-auto my-1">
                                    <a href="export-sm.php" type="button" class="btn btn-success mb-3">Export Surat</a>
                                </div>
                                <form>
                                    <table>
                                        <tr>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <?php 
                                                ...
                                                if (isset($_GET['cari'])) {
                                                    ...
                                                    $query = mysql_query("select * from surat_masuk where concat (kd_sm,no_surat,asal,perihal,tgl_pelaksanaan,jam_pelaksanaan,tempat) like '%".$cari."%' LIMIT $mulai, $halaman");
                                                }else{
                                                $halaman = 2;
                                                $page = isset($_GET["halaman"]) ? (int)$_GET["halaman"] : 1;
                                                $mulai = ($page>1) ? ($page * $halaman) - $halaman : 0;
                                                ...
                                                $total = mysql_num_rows($result);
                                                $pages = ceil($total/$halaman);
                                                $query=mysql_query("SELECT * FROM surat_masuk ORDER BY kd_sm LIMIT $mulai, $halaman")or die(mysql_error);
                                                }
                                                $no = 0;
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th scope="row" width="2%"><?php echo $no?></th>
